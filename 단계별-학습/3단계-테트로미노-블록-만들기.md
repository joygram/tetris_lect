...
2. **자식 큐브 추가**
   ...
   - **스케일 조정**: Transform의 Scale을 (0.9, 0.9, 1)로 설정
...
3. **나머지 큐브 추가**
   ...
   - **스케일 확인**: Scale이 (0.9, 0.9, 1)로 설정되어 있는지 확인
   - Block_2: Local Position (2, 0, 0), Scale (0.9, 0.9, 1)
   - Block_3: Local Position (3, 0, 0), Scale (0.9, 0.9, 1)
   
   **팁**: 모든 블록의 Scale을 동일하게 (0.9, 0.9, 1)로 설정하면 블록들 사이에 약간의 여백이 생깁니다.
