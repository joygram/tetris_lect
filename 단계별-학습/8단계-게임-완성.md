...
- **9단계 (확장)**: 코루틴 이펙트 (3·2·1·Go, 줄 사라짐) → [9단계 - 확장 코루틴 이펙트](./9단계-확장-코루틴-이펙트.md)
- **코드 리뷰**: 스크립트별 코드 해설 → [코드 리뷰 1단계 (GameBoard)](../참고자료/8단계-최종코드리뷰/GameBoard.md)

[← 이전 단계: 7단계 - 점수 및 레벨 시스템](./7단계-점수-레벨-시스템.md) | [다음: 9단계 - 확장 코루틴 이펙트 →](./9단계-확장-코루틴-이펙트.md)
